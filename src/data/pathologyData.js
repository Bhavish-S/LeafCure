...
export const CROP_DISEASE_DATASET = [
  ...
  },
  {
    ...
    symptoms: {
      en: [
        'Vibrant, deep emerald green foliage with intact parallel leaf venation.',
...
export const APP_TRANSLATIONS = {
  en: {
    appTitle: 'AgriCure AI',
    appSubtitle: 'Web-Based Crop Disease Detection & Advisory Portal',
    engineBadge: 'Web Engine v2.4 Active',
    navNewScan: 'New Scan',
    navSaved: 'Saved Diagnoses',
    navAdvisory: 'Field Advisory',
    heroTitle: 'Intelligent Crop Disease Diagnosis & Field Advisory',
    heroDesc: 'Instant neural leaf pathology directly in your browser. Upload field photography or test quick samples for precision lesion detection, confidence scoring, and integrated chemical & organic prescriptions.',
    dropzoneTitle: 'Drag & Drop Crop Leaf Photo Here',
    dropzoneSubtitle: 'or click to browse from device explorer (PNG, JPG, WebP)',
    cameraBtn: 'Take Photo with Web Camera',
    sampleSectionTitle: 'Quick-Demo Evaluation Samples',
    sampleSectionSubtitle: 'Click any sample leaf below to test instant 1-click neural pathology without local files:',
    scanningTitle: 'Neural Engine Analyzing Leaf Pathology...',
    scanStep1: '[200 OK] Image loaded into Canvas buffer & normalized to 512x512...',
    scanStep2: 'Extracting RGB spectral color balance and chlorosis index...',
    scanStep3: 'Segmenting necrotic lesion coordinates & surface area...',
    scanStep4: 'Matching pathological features against plant pathology dataset...',
    scanStep5: 'Generating organic & chemical treatment prescriptions...',
    detectionConfidence: 'Detection Confidence',
    severityLabel: 'Severity Level',
    pathogenTypeLabel: 'Pathogen Classification',
    affectedAreaLabel: 'Estimated Leaf Lesion Area',
    prognosisLabel: 'Prognosis & Recovery Outlook',
    visualInspectorTitle: 'Visual Leaf Inspector (Canvas Engine)',
    showBoundingBoxes: 'Highlight Lesion Bounding Boxes',
    showHeatmap: 'Pathology Heatmap Overlay',
    toggleLabels: 'Show Lesion Labels',
    activeLesionsCount: 'Active Lesions Identified',
    ...
    reportTitle: 'AgriCure AI – Plant Pathology Field Diagnostic Report',
